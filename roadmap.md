...
- [ ] (0.2.x) Keep working on strategators
  - [ ] Get it working with EUR_USD as extra input
  - [ ] Make parentmost node a compatable strategy tree
  - [ ] Solve strategators for intention stream(s) to create a return stream(s)
...
- [ ] (0.3.x) Work on arena v1 - No live trading (practice or live) only mock trading.
  ...
  - [ ] Setup mock strategy infrastructure (0.3.0)
    - Create mock strategator with input data, tree data, target instrument data
  - [ ] Package strategators from incubator (0.3.1)
  - [ ] Run mock strategator (0.3.2)
...
- [x] (0.2.0) Solve manually built strategator working
- [x] (0.2.1) Build strategator working
